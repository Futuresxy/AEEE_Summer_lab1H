...
$(ObjDir)/xf_sobel_resize_tb.cpp_pre.cpp.tb.o : xf_sobel_resize_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling xf_sobel_resize_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -std=c++14 -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/xf_sobel_resize_accel.cpp_pre.cpp.tb.o : xf_sobel_resize_accel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling xf_sobel_resize_accel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -std=c++14 $(IFLAG) $(DFLAG) $< -o $@; \
