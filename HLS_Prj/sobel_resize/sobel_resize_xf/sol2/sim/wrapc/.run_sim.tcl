...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe /home/sxy/Desktop/Vitis_Libraries/vision/data/128x128.png 64 64 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_resize_accel.autotvin.dat"
	set constFileTvOut       "sobel_resize_accel.autotvout.dat"
	set constFileHdlTvIn     "sobel_resize_accel.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_resize_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
