...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel_resize_accel.autotvin_gmem1.dat"
         "c.sobel_resize_accel.autotvin_img_inp.dat"
         "c.sobel_resize_accel.autotvin_img_out1.dat"
         "c.sobel_resize_accel.autotvin_img_out2.dat"
         "c.sobel_resize_accel.autotvin_rows_in.dat"
         "c.sobel_resize_accel.autotvin_cols_in.dat"
         "c.sobel_resize_accel.autotvin_rows_out.dat"
         "c.sobel_resize_accel.autotvin_cols_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel_resize_accel.autotvout_gmem2.dat"
         "rtl.sobel_resize_accel.autotvout_gmem3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
