...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dstgy_data_dout { I 8 vector } p_dstgy_data_num_data_valid { I 3 vector } p_dstgy_data_fifo_cap { I 3 vector } p_dstgy_data_empty_n { I 1 bit } p_dstgy_data_read { O 1 bit } } \
} "
}
