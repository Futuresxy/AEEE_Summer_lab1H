...
set Spec2ImplPortList { 
	...
	rows_c { ap_fifo {  { rows_c_din fifo_data_in 1 16 }  { rows_c_num_data_valid fifo_status_num_data_valid 0 3 }  { rows_c_fifo_cap fifo_update 0 3 }  { rows_c_full_n fifo_status 0 1 }  { rows_c_write fifo_port_we 1 1 } } }
