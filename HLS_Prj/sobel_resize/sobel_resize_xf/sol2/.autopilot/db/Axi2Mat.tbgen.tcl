...
set portList { 
	...
	{ in_mat_data_din sc_out sc_lv 8 signal 2 } 
	{ in_mat_data_full_n sc_in sc_logic 1 signal 2 } 
	{ in_mat_data_write sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "5", "15", "16", "17", "18"],
		...
		"Port" : [
			...
			{"Name" : "in_mat_data", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "AxiStream2Mat_U0", "Port" : "in_mat_data"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Axi2AxiStream_U0", "Parent" : "0", "Child" : ["2", "4"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1_fu_108", "Port" : "gmem1", "Inst_start_state" : "12", "Inst_end_state" : "13"}]},
			{"Name" : "din", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Axi2AxiStream_U0.mul_15s_15s_15_3_1_U13", "Parent" : "1"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AxiStream2Mat_U0", "Parent" : "0", "Child" : ["6", "7", "8", "12", "13", "14"],
		...
		"Port" : [
			...
			{"Name" : "in_mat_data", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "AxiStream2MatStream_2_U0", "Port" : "in_mat_data"}]},
			{"Name" : "rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "entry_proc11_U0", "Port" : "rows"}]},
			{"Name" : "cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "entry_proc11_U0", "Port" : "cols"}]}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.AxiStream2Mat_U0.entry_proc11_U0", "Parent" : "5",
		"CDFG" : "entry_proc11",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.AxiStream2Mat_U0.AxiStream2MatStream_2_U0", "Parent" : "5", "Child" : ["9", "11"],
		...
		"Port" : [
			...
			{"Name" : "in_mat_data", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58", "Port" : "in_mat_data", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.AxiStream2Mat_U0.AxiStream2MatStream_2_U0.mul_32s_32s_32_2_1_U36", "Parent" : "8"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "19", "Max" : "16402"}
	, {"Name" : "Interval", "Min" : "17", "Max" : "16393"}
]}
