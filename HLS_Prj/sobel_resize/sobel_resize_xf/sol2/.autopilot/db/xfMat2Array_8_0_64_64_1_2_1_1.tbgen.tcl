set moduleName xfMat2Array_8_0_64_64_1_2_1_1
set isTopModule 0
...
set C_modelName {xfMat2Array<8, 0, 64, 64, 1, 2, 1>.1}
...
set portList { 
	...
	{ p_dstgy_data_dout sc_in sc_lv 8 signal 2 } 
	{ p_dstgy_data_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ p_dstgy_data_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ p_dstgy_data_empty_n sc_in sc_logic 1 signal 2 } 
	{ p_dstgy_data_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "p_dstgy_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
...
set Spec2ImplPortList { 
	...
	p_dstgy_data { ap_fifo {  { p_dstgy_data_dout fifo_data_in 0 8 }  { p_dstgy_data_num_data_valid fifo_status_num_data_valid 0 3 }  { p_dstgy_data_fifo_cap fifo_update 0 3 }  { p_dstgy_data_empty_n fifo_status 0 1 }  { p_dstgy_data_read fifo_port_we 1 1 } } }
