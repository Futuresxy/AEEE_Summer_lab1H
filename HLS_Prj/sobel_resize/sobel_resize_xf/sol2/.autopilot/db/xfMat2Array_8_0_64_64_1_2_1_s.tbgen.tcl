set moduleName xfMat2Array_8_0_64_64_1_2_1_s
set isTopModule 0
...
set C_modelName {xfMat2Array<8, 0, 64, 64, 1, 2, 1>}
...
set portList { 
	...
	{ p_dstgx_data_dout sc_in sc_lv 8 signal 2 } 
	{ p_dstgx_data_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ p_dstgx_data_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ p_dstgx_data_empty_n sc_in sc_logic 1 signal 2 } 
	{ p_dstgx_data_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "p_dstgx_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_62", "Port" : "p_dstgy_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_62", "Port" : "gmem3", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "dstPtr", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62", "Parent" : "0", "Child" : ["2", "3", "5", "6", "16", "19", "20", "21", "22"],
		...
		"Port" : [
			{"Name" : "p_dstgy_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Mat2AxiStream_U0", "Port" : "p_dstgx_data"}]},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.entry_proc12_U0", "Parent" : "1",
		"CDFG" : "entry_proc12",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0", "Parent" : "1", "Child" : ["4"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0.mul_13s_13s_13_3_1_U200", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2Axi_Block_entry24_proc_U0", "Parent" : "1",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "axibound_1", "Type" : "None", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "20", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0", "Parent" : "1", "Child" : ["7", "8", "9", "13", "14", "15"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "p_dstgx_data"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
	...
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.last_blk_pxl_width_U0", "Parent" : "6",
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "6", "Child" : ["10", "12"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "p_dstgx_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ldata_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "ldata", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "12", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_16ns_16ns_32_1_1_U220", "Parent" : "9"},
	...
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.AxiStream2Axi_U0", "Parent" : "1", "Child" : ["17"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6","9"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "ldata", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.axibound_U", "Parent" : "1"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17", "Max" : "4112"}
	, {"Name" : "Interval", "Min" : "17", "Max" : "4112"}
]}
