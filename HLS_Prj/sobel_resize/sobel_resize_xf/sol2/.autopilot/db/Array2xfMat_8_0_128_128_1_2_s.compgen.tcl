...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_mat_data_din { O 8 vector } in_mat_data_num_data_valid { I 3 vector } in_mat_data_fifo_cap { I 3 vector } in_mat_data_full_n { I 1 bit } in_mat_data_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_mat_rows_c_din { O 32 vector } in_mat_rows_c_num_data_valid { I 3 vector } in_mat_rows_c_fifo_cap { I 3 vector } in_mat_rows_c_full_n { I 1 bit } in_mat_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_mat_cols_c_din { O 32 vector } in_mat_cols_c_num_data_valid { I 3 vector } in_mat_cols_c_fifo_cap { I 3 vector } in_mat_cols_c_full_n { I 1 bit } in_mat_cols_c_write { O 1 bit } } \
} "
}
