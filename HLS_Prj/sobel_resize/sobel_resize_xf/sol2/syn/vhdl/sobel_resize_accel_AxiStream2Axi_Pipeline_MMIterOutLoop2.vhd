...
entity sobel_resize_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_resize_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is 
...
attribute shreg_extract : string;
    ...
    signal ldata_read_reg_135 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_fu_58 : STD_LOGIC_VECTOR (12 downto 0) := "0000000000000";
    signal add_ln1379_fu_102_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1379_fu_96_p2 = ap_const_lv1_0))) then 
                    i_fu_58 <= add_ln1379_fu_102_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_58 <= ap_const_lv13_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln1379_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv13_1));
    ...
    icmp_ln1379_fu_96_p2 <= "1" when (ap_sig_allocacmp_i_1 = p_read) else "0";
    ...
    m_axi_gmem2_WDATA <= ldata_read_reg_135;
