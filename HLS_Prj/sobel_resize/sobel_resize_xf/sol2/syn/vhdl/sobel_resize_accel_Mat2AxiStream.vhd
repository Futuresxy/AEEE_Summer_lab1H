...
entity sobel_resize_accel_Mat2AxiStream is
port (
...
architecture behav of sobel_resize_accel_Mat2AxiStream is 
...
attribute shreg_extract : string;
    ...
    signal MatStream2AxiStream_2_U0_p_dstgx_data_read : STD_LOGIC;
    ...
    component sobel_resize_accel_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_last_blk_pxl_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_MatStream2AxiStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w32_d3_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w4_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component sobel_resize_accel_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_U0 : component sobel_resize_accel_last_blk_pxl_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MatStream2AxiStream_2_U0 : component sobel_resize_accel_MatStream2AxiStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        p_dstgx_data_read => MatStream2AxiStream_2_U0_p_dstgx_data_read,
    ...
    rows_c_U : component sobel_resize_accel_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component sobel_resize_accel_fifo_w32_d3_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component sobel_resize_accel_fifo_w4_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
