...
entity sobel_resize_accel_xfUDivResize is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_resize_accel_xfUDivResize is 
...
attribute shreg_extract : string;
    ...
    component sobel_resize_accel_udiv_64ns_16ns_64_68_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    udiv_64ns_16ns_64_68_seq_1_U71 : component sobel_resize_accel_udiv_64ns_16ns_64_68_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 68,
        din0_WIDTH => 64,
