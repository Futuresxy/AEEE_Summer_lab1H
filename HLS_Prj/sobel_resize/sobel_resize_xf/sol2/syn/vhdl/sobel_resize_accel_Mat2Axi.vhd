...
entity sobel_resize_accel_Mat2Axi is
port (
...
architecture behav of sobel_resize_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc12_U0_dout_c_din : STD_LOGIC_VECTOR (63 downto 0);
    signal entry_proc12_U0_dout_c_write : STD_LOGIC;
    ...
    signal addrbound_U0_p_channel : STD_LOGIC_VECTOR (12 downto 0);
    signal addrbound_U0_rows : STD_LOGIC_VECTOR (12 downto 0);
    signal addrbound_U0_cols : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal Mat2Axi_Block_entry24_proc_U0_ap_return : STD_LOGIC_VECTOR (12 downto 0);
    signal axibound_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_p_dstgx_data_read : STD_LOGIC;
    ...
    signal p_channel_dout : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal axibound_dout : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component sobel_resize_accel_entry_proc12 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        p_channel : OUT STD_LOGIC_VECTOR (12 downto 0);
        rows : IN STD_LOGIC_VECTOR (12 downto 0);
        cols : IN STD_LOGIC_VECTOR (12 downto 0) );
    end component;


    component sobel_resize_accel_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_1 : IN STD_LOGIC_VECTOR (12 downto 0);
        ap_return : OUT STD_LOGIC_VECTOR (12 downto 0) );
    end component;


    component sobel_resize_accel_Mat2AxiStream IS
    port (
    ...
    component sobel_resize_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w13_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w8_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc12_U0 : component sobel_resize_accel_entry_proc12
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component sobel_resize_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component sobel_resize_accel_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component sobel_resize_accel_Mat2AxiStream
    port map (
    ...
    AxiStream2Axi_U0 : component sobel_resize_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component sobel_resize_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component sobel_resize_accel_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_U : component sobel_resize_accel_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component sobel_resize_accel_fifo_w8_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        ...
        vhi_cpy := (others => '0');
        vhi_cpy(5 - 1 downto 0) := ap_const_lv32_D(5 - 1 downto 0);
        v0_cpy := cols;
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_D(5-1 downto 0)));
        ...
        addrbound_U0_cols <= resvalue(13-1 downto 0);
    end process;
    ...
    begin
        ...
        resvalue := res_value and not res_mask;
        addrbound_U0_rows <= resvalue(13-1 downto 0);
    end process;

    ap_done <= AxiStream2Axi_U0_ap_done;
    ap_idle <= ((axibound_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and entry_proc12_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry24_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_entry_proc12_U0_ap_ready and ap_sync_addrbound_U0_ap_ready and ap_sync_Mat2AxiStream_U0_ap_ready);
    entry_proc12_U0_ap_continue <= ap_const_logic_1;
    entry_proc12_U0_ap_start <= ((ap_sync_reg_entry_proc12_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    p_dstgy_data_read <= Mat2AxiStream_U0_p_dstgx_data_read;
end behav;
