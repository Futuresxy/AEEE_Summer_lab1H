...
module sobel_resize_accel_AxiStream2Mat (
        ldata_dout,
        ldata_empty_n,
        ldata_read,
        in_mat_data_din,
...
wire    entry_proc11_U0_rows_read;
wire   [31:0] entry_proc11_U0_rows_c_din;
wire    entry_proc11_U0_rows_c_write;
wire    entry_proc11_U0_cols_read;
wire   [31:0] entry_proc11_U0_cols_c_din;
wire    entry_proc11_U0_cols_c_write;
...
wire   [7:0] AxiStream2MatStream_2_U0_in_mat_data_din;
wire    AxiStream2MatStream_2_U0_in_mat_data_write;
...
sobel_resize_accel_entry_proc11 entry_proc11_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_resize_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_resize_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width_1_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc11_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_1_U0_ap_ready & ap_sync_entry_proc11_U0_ap_ready);

assign cols_read = entry_proc11_U0_cols_read;
...
assign in_mat_data_din = AxiStream2MatStream_2_U0_in_mat_data_din;

assign in_mat_data_write = AxiStream2MatStream_2_U0_in_mat_data_write;
...
assign rows_read = entry_proc11_U0_rows_read;

endmodule //sobel_resize_accel_AxiStream2Mat
