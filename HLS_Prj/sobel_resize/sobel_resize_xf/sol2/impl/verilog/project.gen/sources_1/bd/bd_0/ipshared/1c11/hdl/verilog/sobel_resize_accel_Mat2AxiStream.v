...
module sobel_resize_accel_Mat2AxiStream (
        p_dstgx_data_dout,
...
wire    MatStream2AxiStream_2_U0_p_dstgx_data_read;
...
sobel_resize_accel_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_MatStream2AxiStream_2_s MatStream2AxiStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_resize_accel_fifo_w16_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_resize_accel_fifo_w32_d3_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_resize_accel_fifo_w4_d2_S_x last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign p_dstgx_data_read = MatStream2AxiStream_2_U0_p_dstgx_data_read;

endmodule //sobel_resize_accel_Mat2AxiStream
