...
entity sobel_resize_accel_Array2xfMat_8_0_128_128_1_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_resize_accel_Array2xfMat_8_0_128_128_1_2_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_Axi2Mat_fu_84_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Axi2Mat_fu_84_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_Axi2Mat_fu_84_in_mat_data_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Axi2Mat_fu_84_in_mat_data_write : STD_LOGIC;
    ...
    component sobel_resize_accel_Axi2Mat IS
    port (
        m_axi_gmem1_AWVALID : OUT STD_LOGIC;
        m_axi_gmem1_AWREADY : IN STD_LOGIC;
        m_axi_gmem1_AWADDR : OUT STD_LOGIC_VECTOR (63 downto 0);
...
begin
    grp_Axi2Mat_fu_84 : component sobel_resize_accel_Axi2Mat
    port map (
        ...
        din => srcPtr,
        in_mat_data_din => grp_Axi2Mat_fu_84_in_mat_data_din,
        in_mat_data_full_n => in_mat_data_full_n,
        in_mat_data_write => grp_Axi2Mat_fu_84_in_mat_data_write,
        rows => p_read,
        cols => p_read1,
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    in_mat_data_write_assign_proc : process(grp_Axi2Mat_fu_84_in_mat_data_write, ap_CS_fsm_state3)
    begin
