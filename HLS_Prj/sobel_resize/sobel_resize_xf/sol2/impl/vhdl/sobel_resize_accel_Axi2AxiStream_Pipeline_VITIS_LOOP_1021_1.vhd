...
entity sobel_resize_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_resize_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is 
...
attribute shreg_extract : string;
    ...
    signal gmem1_addr_read_reg_139 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                gmem1_addr_read_reg_139 <= m_axi_gmem1_RDATA;
            end if;
        end if;
    end process;
    ...
    ldata_din <= gmem1_addr_read_reg_139;
