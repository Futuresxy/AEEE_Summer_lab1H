...
entity sobel_resize_accel_xfMat2Array_8_0_64_64_1_2_1_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_resize_accel_xfMat2Array_8_0_64_64_1_2_1_1 is 
...
begin
    ...
    p_dstgy_data_read_assign_proc : process(grp_Mat2Axi_fu_62_p_dstgy_data_read, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            p_dstgy_data_read <= grp_Mat2Axi_fu_62_p_dstgy_data_read;
        else 
            p_dstgy_data_read <= ap_const_logic_0;
        end if; 
    end process;
