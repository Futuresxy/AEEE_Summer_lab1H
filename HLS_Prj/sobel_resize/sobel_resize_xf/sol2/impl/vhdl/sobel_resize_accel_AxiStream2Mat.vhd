...
entity sobel_resize_accel_AxiStream2Mat is
port (
...
architecture behav of sobel_resize_accel_AxiStream2Mat is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc11_U0_rows_read : STD_LOGIC;
    signal entry_proc11_U0_rows_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc11_U0_rows_c_write : STD_LOGIC;
    signal entry_proc11_U0_cols_read : STD_LOGIC;
    signal entry_proc11_U0_cols_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc11_U0_cols_c_write : STD_LOGIC;
    ...
    signal AxiStream2MatStream_2_U0_in_mat_data_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2MatStream_2_U0_in_mat_data_write : STD_LOGIC;
    ...
    component sobel_resize_accel_entry_proc11 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_last_blk_pxl_width_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_AxiStream2MatStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component sobel_resize_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc11_U0 : component sobel_resize_accel_entry_proc11
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        rows_read => entry_proc11_U0_rows_read,
        rows_c_din => entry_proc11_U0_rows_c_din,
        rows_c_num_data_valid => rows_c_num_data_valid,
        rows_c_fifo_cap => rows_c_fifo_cap,
        rows_c_full_n => rows_c_full_n,
        rows_c_write => entry_proc11_U0_rows_c_write,
        cols_dout => cols_dout,
        cols_num_data_valid => ap_const_lv3_0,
        cols_fifo_cap => ap_const_lv3_0,
        cols_empty_n => cols_empty_n,
        cols_read => entry_proc11_U0_cols_read,
        cols_c_din => entry_proc11_U0_cols_c_din,
        cols_c_num_data_valid => cols_c_num_data_valid,
        cols_c_fifo_cap => cols_c_fifo_cap,
        cols_c_full_n => cols_c_full_n,
        cols_c_write => entry_proc11_U0_cols_c_write);

    last_blk_pxl_width_1_U0 : component sobel_resize_accel_last_blk_pxl_width_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2MatStream_2_U0 : component sobel_resize_accel_AxiStream2MatStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        in_mat_data_din => AxiStream2MatStream_2_U0_in_mat_data_din,
        in_mat_data_num_data_valid => ap_const_lv3_0,
        in_mat_data_fifo_cap => ap_const_lv3_0,
        in_mat_data_full_n => in_mat_data_full_n,
        in_mat_data_write => AxiStream2MatStream_2_U0_in_mat_data_write,
    ...
    rows_c_U : component sobel_resize_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc11_U0_rows_c_din,
        if_full_n => rows_c_full_n,
        if_write => entry_proc11_U0_rows_c_write,
        if_dout => rows_c_dout,
    ...
    cols_c_U : component sobel_resize_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc11_U0_cols_c_din,
        if_full_n => cols_c_full_n,
        if_write => entry_proc11_U0_cols_c_write,
        if_dout => cols_c_dout,
    ...
    last_blk_width_channel_U : component sobel_resize_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= AxiStream2MatStream_2_U0_ap_done;
    ap_idle <= (last_blk_pxl_width_1_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and entry_proc11_U0_ap_idle and AxiStream2MatStream_2_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_last_blk_pxl_width_1_U0_ap_ready and ap_sync_entry_proc11_U0_ap_ready);
    cols_read <= entry_proc11_U0_cols_read;
