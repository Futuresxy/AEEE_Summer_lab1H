...
HD_PWD='/home/sxy/Desktop/vivado_workspace/lab1_sobel/Lab1_sobel _max/Lab1_sobel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobel_wrapper.tcl
