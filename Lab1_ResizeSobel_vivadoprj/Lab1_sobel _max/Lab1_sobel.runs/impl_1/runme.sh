...
HD_PWD='/home/sxy/Desktop/vivado_workspace/lab1_sobel/Lab1_sobel _max/Lab1_sobel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sobel_wrapper.tcl -notrace
